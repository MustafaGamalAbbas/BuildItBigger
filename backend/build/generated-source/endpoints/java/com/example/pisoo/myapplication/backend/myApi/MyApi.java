 ...
 * on 2017-08-15 at 06:54:25 UTC 
 * Modify at your own risk.
 */

package com.example.pisoo.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "jokerSayJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link JokerSayJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public JokerSayJoke jokerSayJoke() throws java.io.IOException {
    JokerSayJoke result = new JokerSayJoke();
    initialize(result);
    return result;
  }

  public class JokerSayJoke extends MyApiRequest<com.example.pisoo.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "jokerSayJoke";

    /**
     * Create a request for the method "jokerSayJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link JokerSayJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * JokerSayJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected JokerSayJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.pisoo.myapplication.backend.myApi.model.MyBean.class);
    }

    @Override
    public JokerSayJoke setAlt(java.lang.String alt) {
      return (JokerSayJoke) super.setAlt(alt);
    }

    @Override
    public JokerSayJoke setFields(java.lang.String fields) {
      return (JokerSayJoke) super.setFields(fields);
    }

    @Override
    public JokerSayJoke setKey(java.lang.String key) {
      return (JokerSayJoke) super.setKey(key);
    }

    @Override
    public JokerSayJoke setOauthToken(java.lang.String oauthToken) {
      return (JokerSayJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public JokerSayJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (JokerSayJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public JokerSayJoke setQuotaUser(java.lang.String quotaUser) {
      return (JokerSayJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public JokerSayJoke setUserIp(java.lang.String userIp) {
      return (JokerSayJoke) super.setUserIp(userIp);
    }

    @Override
    public JokerSayJoke set(String parameterName, Object value) {
      return (JokerSayJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.pisoo.myapplication.backend.myApi.model.MyBean> {
